...
\begin{align}
  \mathcal L(H_j)
  &\equiv\mathbf P(\{r_i\}|H_j) \\
  &=\prod_i\mathbf P(r_i|H_j)
\end{align}
where $\mathbf P(r_i|H_j)$ is obtained from aligning the read and the
...
$(H_\text{mat}^\text{ref},H_\text{pat}^\text{ref})$.
...
\begin{align}
  ...
  &=\frac{\mathbf P(H_\text{mat}^\text{ref},H_\text{pat}^\text{ref})}{\mathbf P(H_\text{mat}^\text{nonref},H_\text{pat}^\text{nonref})+\mathbf P(H_\text{mat}^\text{ref},H_\text{pat}^\text{ref})}.
\end{align}
