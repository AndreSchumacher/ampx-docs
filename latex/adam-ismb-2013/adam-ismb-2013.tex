...
to improve, the cost of data processing is increasing. This is costly for scientists who are using genomics in a clinical setting, or who are working on very large datasets for
genome wide association studies~(GWAS, see~\citet{wang05}). To address this issue, it is desirable to be able to compute on genomic data across many machines, but
characteristics of the BAM and VCF file formats practically limit scalability to 8 nodes~\citep{niemenmaa12}.
